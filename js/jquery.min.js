(function(e, t) {
 ...
 function i(e, n, r, i) {
  if (ce.acceptData(e)) {
   ...
   if (c && u[c] && (i || u[c].data) || r !== t || "string" != typeof n) return c || (c = l ? e[s] = te.pop() || ce.guid++ : s), u[c] || (u[c] = l ? {} : {
    toJSON: ce.noop
   }), ("object" == typeof n || "function" == typeof n) && (i ? u[c] = ce.extend(u[c], n) : u[c].data = ce.extend(u[c].data, n)), a = u[c], i || (a.data || (a.data = {}), a = a.data), r !== t && (a[ce.camelCase(n)] = r), "string" == typeof n ? (o = a[n], null == o && (o = a[ce.camelCase(n)])) : o = a, o
  }
 }
 ...
 function P(e, t, n) {
  for (var r, i = (rn[t] || []).concat(rn["*"]), o = 0, a = i.length; a > o; o++)
 ...
 function R(e, t, n) {
  var r, i, o = 0,
   ...
   l = function() {
    if (i) return !1;
    for (var t = Qt || B(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, o = 1 - r, a = 0, l = u.tweens.length; l > a; a++) u.tweens[a].run(o);
 ...
 ce.fn = ce.prototype = {
   ...
   init: function(e, n, r) {
    ...
    if ("string" == typeof e) {
     ...
     if (i[1]) {
      if (n = n instanceof ce ? n[0] : n, ce.merge(this, ce.parseHTML(i[1], n && n.nodeType ? n.ownerDocument || n : G, !0)), ge.test(i[1]) && ce.isPlainObject(n))
   ...
   function y(e, t, n, r, o, a) {
    return r && !r[P] && (r = y(r)), o && !o[P] && (o = y(o, a)), i(function(i, a, s, l) {
     var u, c, f, p = [],
      ...
      v = n ? o || (i ? e : h || r) ? [] : a : y;
     if (n && n(y, v, s, l), r)
      for (u = m(v, d), r(u, [], s, l), c = u.length; c--;)(f = u[c]) && (v[d[c]] = !(y[d[c]] = f));
     if (i) {
      if (o || e) {
       if (o) {
   ...
   function T(e, t, n, r) {
    ...
    if (!r && 1 === u.length) {
     ...
     for (i = ye.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !k.relative[s = a.type]);)
      if ((l = k.find[s]) && (r = l(a.matches[0].replace(Ce, Ne), de.test(o[0].type) && t.parentNode || t))) {
      ...
      return 1 === r && 0 === i ? function(e) {
       ...
       if (m) {
        ...
        if (h = [a ? m.firstChild : m.lastChild], a && v) {
         for (c = m[P] || (m[P] = {}), u = c[e] || [], d = u[0] === W && u[1], p = u[0] === W && u[2], f = d && m.childNodes[d]; f = ++d && f && f[g] || (p = d = 0) || h.pop();)
          if (1 === f.nodeType && ++p && f === t) {
           c[e] = [W, d, p];
           break
          }
        } else if (v && (u = (t[P] || (t[P] = {}))[e]) && u[0] === W) p = u[1];
        else
         for (;
 ...
 ce.Callbacks = function(e) {
   ...
   p = {
    ...
    remove: function() {
     return u && ce.each(arguments, function(e, t) {
      for (var r;
       (r = ce.inArray(t, u, r)) > -1;) u.splice(r, 1), n && (a >= r && a--, s >= r && s--)
     }), this
    },
    has: function(e) {
  ...
  when: function(e) {
   ...
   if (a > 1)
    for (t = Array(a), n = Array(a), r = Array(a); a > i; i++) o[i] && ce.isFunction(o[i].promise) ? o[i].promise().done(u(i, r, o)).fail(l.reject).progress(u(i, n, t)) : --s;
 ...
 ce.fn.extend({
  ...
  removeAttr: function(e, t) {
   var n, r, i = 0,
    o = t && t.match(pe);
   if (o && 1 === e.nodeType)
    for (; n = o[i++];) r = ce.propFix[n] || n, ce.expr.match.bool.test(n) ? Oe && Me || !_e.test(n) ? e[r] = !1 : e[ce.camelCase("default-" + n)] = e[r] = !1 : ce.attr(e, n, ""), e.removeAttribute(Me ? n : r)
  },
  attrHooks: {
   type: {
    set: function(e, t) {
 ...
 ce.event = {
  ...
  remove: function(e, t, n, r, i) {
   ...
   if (m && (c = m.events)) {
    for (t = (t || "").match(pe) || [""], u = t.length; u--;)
     if (s = We.exec(t[u]) || [], d = g = s[1], h = (s[2] || "").split(".").sort(), d) {
  ...
  trigger: function(n, r, i, o) {
   ...
   if (l = f = i = i || G, 3 !== i.nodeType && 8 !== i.nodeType && !Re.test(h + ce.event.triggered) && (h.indexOf(".") >= 0 && (g = h.split("."), h = g.shift(), g.sort()), s = 0 > h.indexOf(":") && "on" + h, n = n[ce.expando] ? n : new ce.Event(h, "object" == typeof n && n), n.isTrigger = o ? 2 : 3, n.namespace = g.join("."), n.namespace_re = n.namespace ? RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = t, n.target || (n.target = i), r = null == r ? [n] : ce.makeArray(r, [n]), c = ce.event.special[h] || {}, o || !c.trigger || c.trigger.apply(i, r) !== !1)) {
    ...
    for (p = 0;
     (l = d[p++]) && !n.isPropagationStopped();) n.type = p > 1 ? u : c.bindType || h, a = (ce._data(l, "events") || {})[n.type] && ce._data(l, "handle"), a && a.apply(l, r), a = s && l[s], a && ce.acceptData(l) && a.apply && a.apply(l, r) === !1 && n.preventDefault();
   ...
   if (l[0] = e, e.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
    for (s = ce.event.handlers.call(this, e, u), n = 0;
     ...
     for (e.currentTarget = o.elem, a = 0;
      (i = o.handlers[a++]) && !e.isImmediatePropagationStopped();)(!e.namespace_re || e.namespace_re.test(i.namespace)) && (e.handleObj = i, e.data = i.data, r = ((ce.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, l), r !== t && (e.result = r) === !1 && (e.preventDefault(), e.stopPropagation()));
 ...
 at.optgroup = at.option, at.tbody = at.tfoot = at.colgroup = at.caption = at.thead, at.th = at.td, ce.fn.extend({
  ...
  domManip: function(e, t, n) {
   ...
   if (c && (l = ce.buildFragment(e, this[0].ownerDocument, !1, !n && this), r = l.firstChild, 1 === l.childNodes.length && (l = r), r)) {
    ...
    if (o)
     for (s = a[a.length - 1].ownerDocument, ce.map(a, m), u = 0; o > u; u++) i = a[u], rt.test(i.type || "") && !ce._data(i, "globalEval") && ce.contains(s, i) && (i.src ? ce._evalUrl(i.src) : ce.globalEval((i.text || i.textContent || i.innerHTML || "").replace(ot, "")));
    l = r = null
   }
   return this
  }
  ...
  buildFragment: function(e, t, n, r) {
   for (var i, o, a, s, l, u, c, f = e.length, p = d(t), h = [], g = 0; f > g; g++)
    ...
    if (!ce.support.leadingWhitespace && Je.test(o) && h.push(t.createTextNode(Je.exec(o)[0])), !ce.support.tbody)
   ...
   for (s && p.removeChild(s), ce.support.appendChecked || ce.grep(x(h, "input"), T), g = 0; o = h[g++];)
    if ((!r || -1 === ce.inArray(o, r)) && (a = ce.contains(o.ownerDocument, o), s = x(p.appendChild(o), "script"), a && y(s), n))
 ...
 var ut, ct, ft, pt = /alpha\([^)]*\)/i,
  dt = /opacity\s*=\s*([^)]*)/,
  ht = /^(top|right|bottom|left)$/,
  gt = /^(none|table(?!-c[ea]).+)/,
  mt = /^margin/,
  yt = RegExp("^(" + fe + ")(.*)$", "i"),
  vt = RegExp("^(" + fe + ")(?!px)[a-z%]+$", "i"),
  bt = RegExp("^([+-])=(" + fe + ")", "i"),
  xt = {
   BODY: "block"
  },
 ...
 Dt = Rt.exec(Lt.toLowerCase()) || [], ce.fn.load = function(e, n, r) {
  ...
  ajax: function(e, n) {
   ...
   var i, o, a, s, l, u, c, f, p = ce.ajaxSetup({}, n),
    d = p.context || p,
 ...
 ce.ajaxSetup({
  ...
  return l || "jsonp" === n.dataTypes[0] ? (o = n.jsonpCallback = ce.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, l ? n[l] = n[l].replace(Ut, "$1" + o) : n.jsonp !== !1 && (n.url += (qt.test(n.url) ? "&" : "?") + n.jsonp + "=" + o), n.converters["script json"] = function() {
   return s || ce.error(o + " was not called"), s[0]
  }, n.dataTypes[0] = "json", a = e[o], e[o] = function() {
   s = arguments
  }, i.always(function() {
   e[o] = a, n[o] && (n.jsonpCallback = r.jsonpCallback, Xt.push(o)), s && ce.isFunction(a) && a(s[0]), s = a = t
  }), "script") : t
 });
 var Vt, Yt, Jt = 0,
 ...
 } : O, Yt = ce.ajaxSettings.xhr(), ce.support.cors = !!Yt && "withCredentials" in Yt, Yt = ce.support.ajax = !!Yt, Yt && ce.ajaxTransport(function(n) {
     ...
     l.send(n.hasContent && n.data || null), r = function(e, i) {
      ...
      try {
       if (r && (i || 4 === l.readyState))
        if (r = t, a && (l.onreadystatechange = ce.noop, Gt && delete Vt[a]), i) 4 !== l.readyState && l.abort();
        else {
      ...
      f && o(s, c, f, u)
     }, n.async ? 4 === l.readyState ? setTimeout(r) : (a = ++Jt, Gt && (Vt || (Vt = {}, ce(e).unload(Gt)), Vt[a] = r), l.onreadystatechange = r) : r()
    },
    abort: function() {
     r && r(t, !0)
    }
 ...
 ce.Animation = ce.extend(R, {
  ...
  var e, n = ce.timers,
   r = 0;
  for (Qt = ce.now(); n.length > r; r++) e = n[r], e() || n[r] !== e || n.splice(r--, 1);
